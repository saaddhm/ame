...
<table id="mytable" class="table table-striped m-4 border" style="width:100%">
    <thead class="text-light" STYLE="background:#B0C4DE">
        <tr>
            ...
            <th>Téléphone</th>
            <th>filier</th>
            <th class="text-center">actcion</th>
        </tr>
    </thead>
    <tbody id="tbapp">
        <?php
       $nomf=$_GET['nomfr'];
        $sql111 = "SELECT *
        FROM apprenties, af,filiere
        WHERE filiere.id_filiere = af.id_filiere AND apprenties.id_apprentie=af.id_apprentie
          AND filiere.nom_filiere = '".$nomf."';
        ;
        ";
        ...
        if ($res111 && mysqli_num_rows($res111) > 0) {
            while ($j = mysqli_fetch_array($res111)) {
                ...
                <tr>
                    ...
                    <td style='width: 300px;' class='text-senter'>
                    
                    <a href='absenceapprenties.php?cin=".$j['id_apprentie']."' class='btn btn-info mx-2  px-3'>absent</a>
                    <a href='note.php?cin=".$j['id_apprentie']."&fl=".$j['id_filiere']."' class='btn btn-warning mx-2  px-3'>note</a>
                    </td>
                </tr>";
            }
        }
