...
if (isset($_POST['submit'])) {
    ...
    // Check if old password matches the stored password and new password matches the confirmed password
            ...
            $st="UPDATE `login_formateur` SET `password`='".$new."' WHERE id_login=".$_SESSION['id']."";
            $resst= $db->query($st);
...
$sql=" SELECT * FROM `log_in` WHERE id_loginad =".$_SESSION['id']."";
$result = $db->query($sql);
...
<a href="#">
<img class="rounded-circle" alt="User Image" src='assets/uploads/<?php echo $i['img'] ?>'>
</a>
</div>
<div class="col ms-md-n2 profile-user-info">
<h4 class="user-name mb-0"><?php echo $i['nom']." ".$i['prenom']; ?> </h4>
...
<p class="col-sm-9"><?php  echo $i['prenom'] ;?> </p>
<p class="col-sm-3 text-muted text-sm-end mb-0 mb-sm-3">Nom</p>
<p class="col-sm-9"><?php echo $i['nom']; ?> </p>
...
<!-- <p class="col-sm-9"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6e040106000a010b2e0b160f031e020b400d0103"></a></p> -->
</div>
<div class="row">
