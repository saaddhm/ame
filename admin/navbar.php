 ...
 <div class="header">
     ...
     <div class="header-left">
         <a href="index.php" class="logo">
             <img src="https://static.wixstatic.com/media/b53106_41b49e4182c64c0d97cffbc47022eabb~mv2.png/v1/fill/w_102,h_132,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/AMESIP%20LOGO%20Final.png" style="width:50px;margin-left:50px;">&nbsp;
...
<img src="assets/img/message.png" alt="" style="width:30px;">
<sup><i class="icon text-light bg-danger  rounded-circle p-1" style><?php  ?></i></sup>
</span>
                 </div>
             </a>
         </li> -->
         ...
         <li class="nav-item dropdown has-arrow new-user-menus">
             <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                 <span class="user-img">
                     <img class="rounded-circle" src=<?php   echo "assets/uploads/".$_SESSION['img']?> width="31"
                         alt="Soeng Souy">
                     <div class="user-text">
             ...
             <div class="dropdown-menu">
                 <div class="user-header">
                     <div class="avatar avatar-sm">
                         <img src=<?php   echo "assets/uploads/".$_SESSION['img']?>  alt="User Image"
     ...
     <div class="sidebar-inner slimscroll">
         <div id="sidebar-menu" class="sidebar-menu">
             <ul>
                 ...
                 <hr>
                 <li class="submenu ">
                     <a href="#" class="text-dark"><i class="fa fa-graduation-cap " aria-hidden="true"></i> <span class="text-dark"> Apprenties</span> <span
                             class="menu-arrow"></span></a>
                     <ul>
                     <hr>

<li><a href="add-student.php" class="text-dark">Pré_inscription</a></li>
<hr>
                     <li><a href="allapprenties.php" class="text-dark">Affectation</a></li>
                     <hr>

                         <li><a href="students.php" class="text-dark">List des apprenties</a></li>

  <hr>

                         <li><a href="edit-student.php" class="text-dark">Modifier </a></li>
                     </ul>
                 </li>
                 <hr>

                 <li class="submenu ">
                     <a href="#" class="text-dark"><i class="fas fa-chalkboard-teacher"></i> <span class="text-dark"> Formateur</span> <span
                             class="menu-arrow"></span></a>
                     <ul><li><a href="allformateur.php" ><span class="text-dark">formateurs</span></a></li>
                     
  <hr>
                         <li><a href="add-formateur.php"><span class="text-dark">Ajouter formateur</span></a></li>
  <hr>

                         <!-- <li><a href="edit-formature.php">Modifier Formateur</a></li>
                         <hr> -->

<li><a href="login-formature.php" class="text-dark">Login Formateur</a></li>
                     </ul>
                 </li>
                 <hr>

                 <li class="submenu ">
                     <a href="#" class="text-dark"><i class="fas fa-book"></i><span class="text-dark"> Formation</span> <span
                             class="menu-arrow"></span></a>
                     <ul>
                     <li> <a href="add-mat.php"><span class="text-dark">Ajouter un Matier</span></a></li>
  <hr>
                         <li><a href="add-fl.php"> <span class="text-dark"> Ajouter un Filiere</span></a></li>
                         <hr>
                         <li><a href="ajmf.php"> <span class="text-dark"> Affectation(matier->filier) </span></a></li>
  <hr>
  <li><a href="filiers.php"> <span class="text-dark"> Filieres</span></a></li>
  <hr>
  <li><a href="matiers.php"> <span class="text-dark">Matiers</span></a></li>
                 ...
                 <hr>
                 <li class="submenu ">
                     <a href="#" class="text-dark"><i class='fas fa-file-pdf'></i><span class="text-dark">Papier Absence</span> <span
                             class="menu-arrow"></span></a>
                     <ul>
...
?>
<a class="nav-link" href="papier.php?nomfr=<?php echo $row2['id_filiere']; ?>"><?php echo $row2['nom_filiere']; ?></a>
<?php
...
?>
                 ...
                 <hr>
                 <li class="submenu">
                     <a href="#" class="text-dark"><i class='fas fa-file-pdf'></i><span class="text-dark"> Imprimer</span> <span
                             class="menu-arrow"></span></a>
                     <ul>
...
?>
<a class="nav-link" href="inparfi.php?nomfr=<?php echo $row2['id_filiere']; ?>"><?php echo $row2['nom_filiere']; ?></a>
<?php
...
?>
                 ...
                 <hr>
                 <li>
                     <a href="mobile.php" class="text-dark"><i class='fas fa-file-pdf'></i><span class="text-dark"> Mobile</span> </a>
</i>
