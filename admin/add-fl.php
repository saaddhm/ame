...
if (isset($_POST['submit'])) {
    ...
    $prd=$_POST['prd'];
      ...
      $sql = "INSERT INTO `filiere`(`nom_filiere`, `period_filier`) VALUES('$nom','$prd') ";
...
<label>Nom Filiére<span class="login-danger">*</span></label>
<input class="form-control" type="text" name="nomfl">
</div>
</div>
<div class="col-12 col-sm-4">
<div class="form-group local-forms">
<label>Période de Filiére<span class="login-danger">*</span></label>
<input class="form-control" type="text" name="prd">
</div>
</div>
<!-- <div class="col-12 col-sm-4">
<div class="form-group local-forms">
